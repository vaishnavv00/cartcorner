    ...
    builder
      ...
      .addCase(addProdToCart.rejected, (state, action) => {
        ...
        if (action.payload?.response?.data?.message) {
          if (action.payload.response.data.message.includes("exceeds available stock")) {
            toast.error(`${action.payload.response.data.message}. Available: ${action.payload.response.data.availableQuantity}`);
          } else {
            toast.error(action.payload.response.data.message);
          }
        } else {
